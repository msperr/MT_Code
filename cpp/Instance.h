...
public:
	...
	simple_vector<vector<int>> customer_routes;
	simple_vector<int> route_customer;
	simple_vector<vector<int>> customerroute_vertices;
	
	// deprecated
	simple_vector<vector<int>> route_vertices;
	simple_vector<vector<int>> customer_vertices;

	simple_vector<double> vehicle_initial_fuel;

	simple_vector<int>    vertex_customer;
	simple_vector<int>    vertex_route;
	...
	simple_matrix<bool> feasible_edge;
